...
def apply_dimensionality_reduction_credit(X):
...
df_credit = select_random(df_credit)
X_credit = df_credit.drop(columns=['Class'])

X_scaled_credit, X_pca_credit, explained_variance_pca_credit, explained_variance_ratio_credit, X_ica_credit, kurtosis_ica_credit, kurtosis_scores_credit, X_rp_credit, optimal_pca_components_credit, optimal_ica_components_credit = apply_dimensionality_reduction_credit(X_credit)
analyze_and_visualize(X_scaled_credit, X_pca_credit, explained_variance_pca_credit, explained_variance_ratio_credit, X_ica_credit, kurtosis_ica_credit, kurtosis_scores_credit, X_rp_credit, optimal_pca_components_credit, optimal_ica_components_credit)
